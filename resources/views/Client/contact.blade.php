            ...
            <div dir="rtl" class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="blog_contact_info_div wow fadeInUp">
                        ...
                        <h4>تماس با ما</h4>
                        <p>+1800-124-1425 <br> +1800-124-1426</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="blog_contact_info_div wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4>ایمیل</h4>
                        <p><a href="#">example123@mail.com</a> <br> <a href="#">blogerexample@mail.com</a></p>
                    </div>
                </div>
            ...
            <div  class="row">
                <div class="col-lg-8 col-md-10 col-sm-12 col-12 offset-lg-2 offset-md-1 blog_toppadder40">
                    <div class="blog_contact_form_div wow fadeInUp">
                        <div dir="rtl" class="blog_main_heading_div">
                            <div class="blog_heading_div">
                                <h3 class="blog_bg_lightgreen">با ما در تماس باشید</h3>
                            </div>
                        </div>
                        <div class="blog_contact_form_div_inner">
                            <h4 class="text-right">پیغامی بگذارید</h4>
                            <div class="contact_form">
                                <form dir="rtl" class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="blog_form_group">
                                            <input type="text" id="ur_name" class="form-control" placeholder="نام">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="blog_form_group">
                                            <input type="text" id="ur_mail" class="form-control" placeholder="ایمیل">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="blog_form_group">
                                            <input type="text" id="ur_phone" class="form-control" placeholder="شماره تلفن">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="blog_form_group">
                                            <input type="text" id="sub" class="form-control" placeholder="موضوع">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="blog_form_group">
                                            <textarea id="msg" class="form-control" placeholder="متن پیام" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="text-right col-lg-12 col-md-12 col-sm-12 col-12">
                                        <button id="send_btn" class="blog_btn blog_bg_pink">ارسال</button>
                                        <div id="err"></div>
                                    </div>
                                </form>
                            </div>
