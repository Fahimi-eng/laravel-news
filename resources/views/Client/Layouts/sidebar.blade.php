<div class="blog_right_toggle_sidebar">
    ...
    <div class="blog_togglediv">
        ...
        <div dir="rtl" class="blog_sidebar">
            <div class="widget widget_social">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_pink">با ما باشید</h3>
                    </div>
                </div>
                <ul>
                    <li>
            ...
            <div class="widget widget_recent_post">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_orange">داغ ترین ها</h3>
                    </div>
                </div>
                <ul>
                    <li>
                        <div class="blog_recent_post">
                            ...
                            <div class="blog_recent_post_content">
                                <h4><a class="pe-2" href="blog_single_fullwidth.html">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</a></h4>
                                <p dir="ltr">Sep 21,2018 <a href="#">- ورزشی</a></p>
                            </div>
                        </div>
                    </li>
                    <li>
            ...
            <div class="widget widget_recent_news">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_lightblue">تازه ترین</h3>
                    </div>
                </div>
                <ul>
                    <li>
                        <div class="blog_news">
                            <div class="blog_news_title">
                                <h4><a href="blog_single_fullwidth.html">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم</a></h4>
                                <p dir="ltr">Sep 21,2018 <a href="#">- ورزشی</a></p>
                            </div>
            ...
            <div class="widget widget_instagram_news">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_pink">اینستاگرام</h3>
                    </div>
                </div>
                <ul>
                    <li>
            ...
            <div class="widget widget_categories">
                ...
                <ul>
                    <li><a href="#">زیبایی <span>(02)</span></a></li>
                    <li><a href="#">فشن <span>(45)</span></a></li>
                    <li><a href="#">سبک زندگی <span>(124)</span></a></li>
                    <li><a href="#">میکاپ  <span>(75)</span></a></li>
                    <li><a href="#">متفرقه   <span>(1,242)</span></a></li>
                    <li><a href="#">سیر و سفر  <span>(186)</span></a></li>
                </ul>
            </div>
            <div class="widget widget_special_post">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_pink">از دستت نره</h3>
                    </div>
                </div>
                <ul>
                    <li>
                        <div class="blog_post_slider_wrapper">
                            <a href="blog_single_fullwidth.html" class="blog_post_slider_img">
                                <img src="https://via.placeholder.com/230x218" class="img-fluid" alt="">
                            </a>
                            <div class="blog_post_slider_content">
                                <h2><a class="text-right" href="#">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم </a></h2>
            ...
            <div class="widget widget_archive">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_blue">آرشیو</h3>
                    </div>
                </div>
                <ul>
                    <li>
                        <a href="#">فروردین 1401 <span>(02)</span></a>
                    </li>
                    <li>
                        <a href="#">اردیبهشت 1401 <span>(45)</span></a>
                    </li>
                    <li>
                        <a href="#">خرداد 1401 <span>(125)</span></a>
                    </li>
                    <li>
                        <a href="#">آبان 1401 <span>(75)</span></a>
                    </li>
                    <li>
                        <a href="#">بهمن 1401 <span>(10)</span></a>
                    </li>
                    <li>
                        <a href="#">January  1402 <span>(186)</span></a>
                    </li>
                    <li>
                        <a href="#">February  1402 <span>(02)</span></a>
                    </li>
                </ul>
            </div>
            <div class="widget widget_newsletter">
                <div class="blog_main_heading_div">
                    <div class="blog_heading_div">
                        <h3 class="blog_bg_pink">اشتراک</h3>
                    </div>
                </div>
                <div class="blog_newsletter">
                    <p>برای دریافت اعلانات سایت ایمیل خود را وارد کنید</p>
            ...
            <div class="ads_widget">
                <a href="#"><img src="https://via.placeholder.com/270x350?text=Ads%20Area" class="img-fluid" alt=""></a>
            </div>
        </div>
    </div>
</div>
