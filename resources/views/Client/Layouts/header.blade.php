<div class="blog_header_style2">
    ...
    <div dir="rtl" class="blog_main_header">
        <div class="blog_tranding_slider">
            <div class="swiper-container">
                <div dir="rtl" class="swiper-wrapper">
                    <div class="swiper-slide">
                        <p class="me-3"><span><i></i></span> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                    </div>
                    <div class="swiper-slide">
                        <p class="me-3"><span><i></i></span>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                    </div>
        ...
        <div class="blog_main_menu">
            <div class="blog_main_menu_innerdiv">
                <ul>
                    ...
                    <li><a href="world.html">سیاست <span>جدید</span></a></li>
                    <li><a href="world.html">جهان</a></li>
                    <li><a href="world.html">تکنولوژی</a></li>
                    <li><a href="world.html">ورزشی <span>جدید</span></a></li>
                    <li><a href="world.html">سبک زندگی</a></li>
                    <li><a href="world.html">سیر ور سفر</a></li>
                    <li><a href="world.html">فشن <span>جدید</span></a></li>
                    <li><a href="#">صفحات</a>
                        <ul dir="rtl" class="sub-menu text-right">
                            <li><a href="blog_single_fullwidth.html">صفحه خبر</a></li>
                            <li><a href="contactus.html">تماس با ما</a></li>
                            <li><a href="error.html">خطا</a></li>
                            <li><a href="terms_condition.html">شرایط خدمات</a></li>
                            <li><a href="privacy_policy.html">حریم خصوصی</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <li class="blog_search">
                    ...
                    <div class="blog_search_popup">
                        ...
                        <form class="form-inline">
                            <h3>کلمه کلیدی مورد نظر خود را وارد نمایید</h3>
                            <div class="blog_form_group">
                                <input type="text" class="form-control" placeholder="اینجا بنویسید ...">
                                <button type="button" class="blog_header_search">جستجو</button>
                            </div>
