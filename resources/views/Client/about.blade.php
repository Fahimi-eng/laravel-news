...
@section('content')
    ...
    <div class="blog_white_wrapper blog_toppadder60 blog_bottompadder60">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="blog_innerpages blog_aboutpage">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="blog_about_img wow fadeInUp">
                                <img src="https://via.placeholder.com/500x580" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="blog_about_contact wow fadeInUp" data-wow-delay="0.2s">
                                <h3>Provide the best Blog Services</h3>
                                <p><span class="blog_color_pink">Wlog amet consectetur adipisicing elit, </span>sed do end eiusmod tempor incididunt  iolore miagna aliqua. Ut enim ad minim is aeveniam, quis nostrud exercitation ullamco laboris nisi ut aliqeuipi ex ieiaiommdo consequatuis aute irure dolor in reprehenderit in voluptate velit eses ese cillum dolore reeu fugiaetit nullaiatuir Excepteur sint occaeciat partie is cupidatat non proident, sunt in culpa ueriunt moillit anim id ethe most st laborumispiciatis unde onis iste natus errorlaudantium, totam rem aperiam and the past in value.</p>
                                <a href="#" class="blog_btn blog_bg_pink">Get Started Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                    <div class="blog_histroy_div wow fadeInUp">
                        <ul>
                            <li>
                                <div class="blog_date">
                                    <h4>1998-2003</h4>
                                ...
                                <div class="history_data">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sedeiusmod tempoeir incididunt ut labore et dolore magna aliqua. Ut ii ad minim veniam and isi quis nostrud exercitation ullamco.</p>
                                </div>
                            </li>
                            <li>
                                <div class="blog_date">
                                ...
                                <div class="history_data">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sedeiusmod tempoeir incididunt ut labore et dolore magna aliqua.</p>
                                </div>
                            </li>
                            <li>
                                <div class="blog_date">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                    <div class="blog_history_img wow fadeInUp" data-wow-delay="0.2s">
                        <img src="https://via.placeholder.com/470x454" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="blog_white_wrapper blog_toppadder60 blog_bottompadder60">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="blog_whatwedo_img wow fadeInUp">
                        <img src="https://via.placeholder.com/555x350" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="blog_whatwedo_content wow fadeInUp" data-wow-delay="0.2s">
                        <h3>Leverage agile frameworks to provide a robust</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempoeir incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam and isi quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequateuis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu feiraugiat nulla pariatur. Excepteur sint occaecat  proident,</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 order-lg-2 order-md-2">
                    <div class="blog_whatwedo_img wow fadeInUp" data-wow-delay="0.2s">
                        <img src="https://via.placeholder.com/555x350" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 order-lg-1 order-md-1">
                    <div class="blog_whatwedo_content wow fadeInUp">
                        <h3>Leverage agile frameworks to provide a robust</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempoeir incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam and isi quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequateuis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu feiraugiat nulla pariatur. Excepteur sint occaecat  proident,</p>
                    </div>
                </div>
    ...
    <div class="blog_main_wrapper blog_toppadder60 blog_bottompadder60">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="blog_testimonial_slider wow fadeInUp">
                        <div class="swiper-container testimonial-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="http://via.placeholder.com/100x100" class="img-fluid" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="http://via.placeholder.com/100x100" class="img-fluid" alt="">
                                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial_data">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiuod tempioir incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniamei quis nostrud exercitation ullamco laboris nisi ut consequat Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ullamco.</p>
                                        <h4>Vella Doe <span>-designer</span></h4>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial_data">
                        ...
                        <!--<div class="slider">
                            <div class="bx-pager">
                                <a data-slide-index="0" href=""><img src="http://via.placeholder.com/100x100" class="img-fluid" alt=""></a>
                                <a data-slide-index="1" href=""><img src="http://via.placeholder.com/100x100" class="img-fluid" alt=""></a>
                                <a data-slide-index="2" href=""><img src="http://via.placeholder.com/100x100" class="img-fluid" alt=""></a>
                            </div>
                            <ul class="bxslider">
                                <li>
                                    <div class="testimonial_data">
